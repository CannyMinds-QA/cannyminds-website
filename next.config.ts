      ...
      },
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' https://embed.tawk.to https://va.tawk.to https://www.clarity.ms https://analytics.ahrefs.com https://va.vercel-insights.com https://va.vercel-scripts.com",
              "style-src 'self' 'unsafe-inline' https://embed.tawk.to",
              "img-src 'self' data: https: blob:",
              "font-src 'self' https://embed.tawk.to",
              "connect-src 'self' https://va.tawk.to https://embed.tawk.to wss://ws.tawk.to https://www.clarity.ms https://va.vercel-insights.com https://vitals.vercel-insights.com",
