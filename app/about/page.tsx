  ...
  const leaders = [
    {
      ...
      companies: [
        "Zen Marketing",
        "NewGen Soft Tech Ltd",
        "WRITER Information",
        "Intelics Solutions Nigeria Ltd",
        "Prasad Corporation"
      ],
    ...
    },
    {
      ...
      education: "DEEE., MBA (Production)",
      experienceYears: "35+ Years",
      companies: [
        "Hinduja Foundries Ltd",
        "Light Alloy Products Ltd (TVS)",
        "RAPSRI Engg Industries Ltd",
        "WRITER Information"
      ],
    ...
    },
    {
      name: "Maheshkumar",
      title: "VP – Operations",
      education: "B.E., MBA (HR)",
      experienceYears: "25+ Years",
      companies: [
        "Raveen Systems Pvt Ltd",
        "WRITER Information"
      ],
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {leaders.map((leader, idx) => (
                <div key={idx} className={`bg-gradient-to-br from-${leader.color}-50 to-white border-2 border-${leader.color}-200 rounded-xl p-6 sm:p-8 hover:border-${leader.color}-600 transition-all`}>
                  ...
                  <p className={`text-sm sm:text-base font-bold text-${leader.color}-700 mb-6 text-center`}>
                    {leader.title}
                  </p>
                  <div className="text-sm sm:text-sm text-gray-700 leading-relaxed text-center space-y-4">
                    <div>
                      <span className="text-primary font-semibold block mb-1">Educational Qualification:</span>
                      <span className="font-medium">{leader.education}</span>
                    </div>
                    <div>
                      <span className="text-primary font-semibold block mb-1">Experience : {leader.experienceYears}</span>
                      <div className="font-medium space-y-0.5 mt-1 text-gray-800">
