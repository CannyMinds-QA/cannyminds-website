                ...
                <div className="container mx-auto px-6 lg:px-12 py-12">
                    <div className="grid lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-9 space-y-24">
                            ...
                            <section id="expert-insights" className="scroll-mt-24 bg-indigo-50/50 rounded-2xl p-8 border border-indigo-100">
                                <motion.div
                                    initial="hidden"
                                    whileInView="visible"
                                    viewport={{ once: true }}
                                ...
                                >
                                    <div className="flex flex-col md:flex-row gap-8 items-start">
                                        <div className="flex-shrink-0 text-center md:text-left">
                                            <div className="w-24 h-24 rounded-full bg-white border-2 border-indigo-200 mb-4 overflow-hidden mx-auto md:mx-0">
                                                <Image
                                            ...
                                            <p className="text-sm font-semibold text-indigo-600 mb-2">Subject Matter Expert – Gen AI</p>
                                        ...
                                        <div className="space-y-6">
                                            <div>
                                                ...
                                                <p className="text-gray-600 leading-relaxed">
                                                    Our textile AI solutions are developed by a team with deep domain expertise,
