...
const industryData: Record<string, {
  ...
  heroTitle: string;
  heroSubtitle: string;
  heroDescription: string | React.ReactNode;
...
export default function IndustryClient({ industrySlug }: { industrySlug: string }) {
                  ...
                  >
                    <div className={`grid lg:grid-cols-5 gap-0`}>
                      ...
                      <div className={`lg:col-span-3 p-8 ${isEven ? 'lg:order-2' : 'lg:order-1'}`}>
                        <div className={`mb-4 ${industry.primaryColor}`}>
                          <UseCaseIcon sx={{ fontSize: 40 }} />
                        </div>
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className={`w-24 h-24 rounded-full bg-white border-2 ${industry.borderColor} mb-4 overflow-hidden flex items-center justify-center`}>
                      <Image
                        ...
                        alt="Udayakumar Murugan - Gen AI Expert"
                        width={96}
                        height={96}
                        className="w-full h-full object-cover"
                      />
                    ...
                    <p className={`text-sm font-semibold ${industry.primaryColor} mb-2`}>Subject Matter Expert – Gen AI</p>
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900 text-sm">50+ AI Implementations</p>
