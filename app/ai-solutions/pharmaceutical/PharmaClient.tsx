...
export default function PharmaClient() {
    const tocItems = [
        ...
        ...pharmaContent.useCases.map((uc) => ({ id: uc.id, title: uc.title.replace("Gen AI-Enabled ", "").replace("AI Vision–Enabled ", "") })),
                ...
                <div className="container mx-auto px-6 lg:px-12 py-12">
                    <div className="grid lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-9 space-y-24">
                                    ...
                                    {[...pharmaContent.useCases.slice(0, 6)].map((useCase) => { // Show top 6 initially
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <h3 className="text-xl font-bold text-gray-900 mb-2">{useCase.title.replace("Gen AI-Enabled ", "").replace("AI Vision–Enabled ", "")}</h3>
                            ...
                            <section id="expert-insights" className="scroll-mt-24 bg-purple-50/50 rounded-2xl p-8 border border-purple-100">
                                <motion.div
                                    initial="hidden"
                                    whileInView="visible"
                                    viewport={{ once: true }}
                                ...
                                >
                                    <div className="flex flex-col md:flex-row gap-8 items-start">
                                        <div className="flex-shrink-0 text-center md:text-left">
                                            <div className="w-24 h-24 rounded-full bg-white border-2 border-purple-200 mb-4 overflow-hidden mx-auto md:mx-0">
                                                <Image
                                            ...
                                            <p className="text-sm font-semibold text-purple-600 mb-2">Subject Matter Expert – Gen AI</p>
