...
export default function InsuranceSolutionsPage() {
    const tocItems = [
        ...
        ...insuranceContent.useCases.map((uc) => ({ id: uc.id, title: uc.title })),
    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-white">
                ...
                {/* HERO SECTION */}
                <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-blue-50 pt-20">
                    ...
                    <div className="container mx-auto px-6 lg:px-12 relative z-10 py-16">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <motion.div
                                ...
                                variants={fadeInUp}
                            >
                                <div className="inline-block px-4 py-1.5 rounded-full bg-blue-100 text-blue-700 font-medium text-sm mb-6 border border-blue-200">
                                    Insurance Industry
                                </div>
                                ...
                                <p className="text-xl text-gray-600 mb-8 max-w-xl leading-relaxed">
                                    {insuranceContent.hero.subtitle}. {insuranceContent.hero.description}
                                </p>
                            ...
                            >
                                ...
                                {/* Decorative Elements */}
                                <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-blue-100 rounded-xl -z-10" />
                                <div className="absolute -top-4 -left-4 w-16 h-16 bg-blue-100 rounded-lg -z-10" />
                            </motion.div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="grid lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-9 space-y-24">
                            ...
                            <section id="use-cases-grid" className="scroll-mt-24">
                                ...
                                >
                                    {[...insuranceContent.useCases.slice(0, 6)].map((useCase) => {
                            ...
                            <div className="space-y-16">
                                {insuranceContent.useCases.map((useCase, index) => {
                            ...
                            <section id="regulatory-compliance" className="scroll-mt-24 bg-slate-900 text-white rounded-2xl p-8 lg:p-12">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    {insuranceContent.regulatoryMapping.map((reg, i) => (
                            ...
                            <section id="case-studies" className="scroll-mt-24">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    {insuranceContent.caseStudies.map((study, i) => (
                            ...
                            <section id="expert-insights" className="scroll-mt-24 bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
                                <motion.div
                                    initial="hidden"
                                    whileInView="visible"
                                    viewport={{ once: true }}
                                ...
                                >
                                    <div className="flex flex-col md:flex-row gap-8 items-start">
                                        <div className="flex-shrink-0 text-center md:text-left">
                                            ...
                                            <p className="text-sm font-semibold text-blue-600 mb-2">Subject Matter Expert – Gen AI</p>
                                        ...
                                        <div className="space-y-6">
                                            <div>
                                                ...
                                                <p className="text-gray-600 leading-relaxed">
                                                    Our insurance AI solutions are developed by a team with deep domain expertise,
