...
export default function HealthcareClient() {
    const tocItems = [
        ...
        ...healthcareContent.useCases.map((uc) => ({ id: uc.id, title: uc.title })),
    ...
    return (
        <>
            <main className="min-h-screen bg-white">
                ...
                {/* HERO SECTION */}
                <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-red-50 pt-20">
                    ...
                    <div className="container mx-auto px-6 lg:px-12 relative z-10 py-16">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <motion.div
                                ...
                                variants={fadeInUp}
                            >
                                <div className="inline-block px-4 py-1.5 rounded-full bg-red-100 text-red-700 font-medium text-sm mb-6 border border-red-200">
                                    Healthcare & Hospitals
                                </div>

                                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                    <TextAnimate animation="blurIn" by="word">
                                        {healthcareContent.hero.title}
                                    </TextAnimate>
                                </h1>

                                <p className="text-xl text-gray-600 mb-8 max-w-xl leading-relaxed">
                                    {healthcareContent.hero.subtitle}. {healthcareContent.hero.description}
                                </p>
                            ...
                            >
                                ...
                                {/* Decorative Elements */}
                                <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-red-100 rounded-xl -z-10" />
                                <div className="absolute -top-4 -left-4 w-16 h-16 bg-red-100 rounded-lg -z-10" />
                            </motion.div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="grid lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-9 space-y-24">
                            ...
                            <section id="use-cases-grid" className="scroll-mt-24">
                                ...
                                >
                                    <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                                        10+ Ways Gen AI Transforms Healthcare
                                    </h2>
                                    <p className="text-gray-600 max-w-2xl mx-auto">
                                        From Patient Registration to Analytics, explore our comprehensive suite of HIPAA-compliant AI solutions.
                                    </p>
                                </motion.div>
                                ...
                                >
                                    {[...healthcareContent.useCases.slice(0, 6)].map((useCase) => {
                            ...
                            <div className="space-y-16">
                                {healthcareContent.useCases.map((useCase, index) => {
                            ...
                            <section id="regulatory-compliance" className="scroll-mt-24 bg-slate-900 text-white rounded-2xl p-8 lg:p-12">
                                <div className="text-center mb-12">
                                    ...
                                    <p className="text-slate-400 max-w-2xl mx-auto">
                                        Our Gen AI architecture is built from the ground up to meet the strictest healthcare compliance standards.
                                    </p>
                                </div>

                                <div className="grid md:grid-cols-2 gap-6">
                                    {healthcareContent.regulatoryMapping.map((reg, i) => (
                            ...
                            <section id="case-studies" className="scroll-mt-24">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    {healthcareContent.caseStudies.map((study, i) => (
                            ...
                            <section id="expert-insights" className="scroll-mt-24 bg-red-50/50 rounded-2xl p-8 border border-red-100">
                                <motion.div
                                    initial="hidden"
                                    whileInView="visible"
                                    viewport={{ once: true }}
                                ...
                                >
                                    <div className="flex flex-col md:flex-row gap-8 items-start">
                                        <div className="flex-shrink-0 text-center md:text-left">
                                            <div className="w-24 h-24 rounded-full bg-white border-2 border-red-200 mb-4 overflow-hidden mx-auto md:mx-0">
                                                <Image
                                            ...
                                            <p className="text-sm font-semibold text-red-600 mb-2">Subject Matter Expert – Gen AI</p>
                                        ...
                                        <div className="space-y-6">
                                            <div>
                                                ...
                                                <p className="text-gray-600 leading-relaxed">
                                                    Our healthcare AI solutions are developed by a team with deep domain expertise,
                ...
                <section className="py-24 bg-blue-600">
                    <div className="container mx-auto px-6 lg:px-12 text-center">
                        ...
                        <p className="text-blue-100 text-xl mb-10 max-w-2xl mx-auto">
                            Schedule a demo with our Healthcare AI team to see Patient Registration and Billing Automation in action.
                        </p>
