...
export default function EcommerceSolutionsPage() {
    const tocItems = [
        ...
        ...ecommerceContent.useCases.map((uc) => ({ id: uc.id, title: uc.title })),
    ...
    return (
        <>
            <main className="min-h-screen bg-white">
                ...
                {/* HERO SECTION */}
                <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-cyan-50 pt-20">
                    ...
                    <div className="container mx-auto px-6 lg:px-12 relative z-10 py-16">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <motion.div
                                ...
                                variants={fadeInUp}
                            >
                                <div className="inline-block px-4 py-1.5 rounded-full bg-cyan-100 text-cyan-700 font-medium text-sm mb-6 border border-cyan-200">
                                    E-Commerce & Retail
                                </div>

                                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                    <TextAnimate animation="blurIn" by="word">
                                        {ecommerceContent.hero.title}
                                    </TextAnimate>
                                </h1>

                                <p className="text-xl text-gray-600 mb-8 max-w-xl leading-relaxed">
                                    {ecommerceContent.hero.subtitle}. {ecommerceContent.hero.description}
                                </p>
                            ...
                            >
                                ...
                                {/* Decorative Elements */}
                                <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-cyan-100 rounded-xl -z-10" />
                                <div className="absolute -top-4 -left-4 w-16 h-16 bg-cyan-100 rounded-lg -z-10" />
                            </motion.div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="grid lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-9 space-y-24">
                            ...
                            <section id="use-cases-grid" className="scroll-mt-24">
                                ...
                                >
                                    <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                                        25+ Ways Gen AI Transforms E-Commerce
                                    </h2>
                                    <p className="text-gray-600 max-w-2xl mx-auto">
                                        From product content automation to personalized shopping, explore our comprehensive suite of retail AI solutions.
                                    </p>
                                </motion.div>
                                ...
                                >
                                    {[...ecommerceContent.useCases.slice(0, 6)].map((useCase) => {
                            ...
                            <div className="space-y-16">
                                {ecommerceContent.useCases.map((useCase, index) => {
                                                    ...
                                                    <div className="p-6 bg-white rounded-xl border border-gray-100 shadow-sm">
                                                        ...
                                                        <div className="mt-6 pt-6 border-t border-gray-100">
                                                            <div className="flex flex-wrap gap-2">
                                                                <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium bg-cyan-50 text-cyan-700 border border-cyan-100">
                                                                    PCI DSS
                                                                </span>
                            ...
                            <section id="regulatory-compliance" className="scroll-mt-24 bg-slate-900 text-white rounded-2xl p-8 lg:p-12">
                                <div className="text-center mb-12">
                                    ...
                                    <p className="text-slate-400 max-w-2xl mx-auto">
                                        Our Gen AI architecture is built from the ground up to meet e-commerce security and privacy standards.
                                    </p>
                                </div>

                                <div className="grid md:grid-cols-2 gap-6">
                                    {ecommerceContent.regulatoryMapping.map((reg, i) => (
                            ...
                            <section id="case-studies" className="scroll-mt-24">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    {ecommerceContent.caseStudies.map((study, i) => (
                            ...
                            <section id="expert-insights" className="scroll-mt-24 bg-cyan-50/50 rounded-2xl p-8 border border-cyan-100">
                                <motion.div
                                    initial="hidden"
                                    whileInView="visible"
                                    viewport={{ once: true }}
                                ...
                                >
                                    <div className="flex flex-col md:flex-row gap-8 items-start">
                                        <div className="flex-shrink-0 text-center md:text-left">
                                            <div className="w-24 h-24 rounded-full bg-white border-2 border-cyan-200 mb-4 overflow-hidden mx-auto md:mx-0">
                                                <Image
                                            ...
                                            <p className="text-sm font-semibold text-cyan-600 mb-2">Subject Matter Expert – Gen AI</p>
                                        ...
                                        <div className="space-y-6">
                                            <div>
                                                ...
                                                <p className="text-gray-600 leading-relaxed">
                                                    Our e-commerce AI solutions are developed by a team with deep domain expertise,
                ...
                <section className="py-24 bg-blue-600">
                    <div className="container mx-auto px-6 lg:px-12 text-center">
                        ...
                        <p className="text-blue-100 text-xl mb-10 max-w-2xl mx-auto">
                            Schedule a demo with our E-Commerce AI team to see Product Content Automation and Personalization in action.
                        </p>
