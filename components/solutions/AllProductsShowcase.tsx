...
const products = [
    ...
    {
        name: "CannyPQMS",
        title: "Pharmaceutical Quality Management System",
        description: "Enterprise pharma QMS software with 18 GxP-critical modules. CAPA, DMS, Audit, Deviation, e-Sign and more, built for FDA, WHO, and ICH Q9 compliance.",
        longDescription: "Purpose-built pharmaceutical quality management software for regulated manufacturers. Unifies CAPA, Document Control, Deviation, Audit, Training, Validation, and 14 more modules into a single on-premise platform compliant with FDA 21 CFR Part 11, ICH Q9, EMA, WHO, CDSCO, and NAFDAC.",
        icon: PolicyIcon,
        color: "text-teal-600",
        bg: "bg-teal-50",
        borderColor: "hover:border-teal-500",
        link: "/product/cannypqms",
        features: ["FDA 21 CFR Part 11", "18 GxP Modules", "CAPA Management", "ICH Q9 Risk Mgmt", "On-Premise"],
        stats: { value: "18", label: "QMS Modules" },
    },
    {
        name: "CannyScan",
                    ...
                    <div className="bg-primary rounded-3xl p-12 md:p-20 text-center text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10 max-w-2xl mx-auto">
                            ...
                            <p className="text-blue-100 text-lg mb-8">
                                Join 100+ organizations that efficiently manage their business with CannyMinds.
                            </p>
                            <Link href="/contact">
